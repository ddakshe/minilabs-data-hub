...
export const OASIS_CATEGORIES = [
  ...
  // ── 간편식은 snack 으로 내린다 (밥상 구성에서 빠진다) ─────────
  //    이 카테고리들은 소스·면·죽·주먹밥·샐러드까지 다 품고 있다. main 에
  //    두면 목적함수(절약액 최대)가 할인율 높은 `밥간장소스 50%` 같은 것을
  //    메인으로 고른다(실측). 카테고리 이름이 "간편식"이라고 해서 그 안이
  //    끼니가 되는 것은 아니다.
  //
  //    main 은 완제품 단백질(17·1195·22·43)만으로 44건이고, 최소 조합가가
  //    6끼 기준 18,130 → 22,660 으로 오르지만 예산 30,000 안에 든다(실측).
  //    4끼 17,880/20,000 · 9끼 36,970/45,000 도 통과한다.
  { id: 120, slot: 'snack', label: '밀키트I도시락' },
  { id: 57, slot: 'snack', label: '간편식사' },
  { id: 247, slot: 'snack', label: '간편식' },
  { id: 53, slot: 'snack', label: '간편식(2)' },
]
